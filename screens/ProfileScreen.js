      ...
      <ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}>
        ...
        {memories.length === 0 ? (
          ...
          memories.map((memory, index) => (
            <View key={memory.id || index} style={styles.historyCard}>
              <View style={styles.historyLeft}>
                <Text style={styles.historyDate}>{formatDate(memory.date)}</Text>
                ...
                <View style={styles.historyMeta}>
                  ...
                  {memory.photos && memory.photos.length > 0 && (
                    <>
                      <Ionicons name="image-outline" size={14} color="#999" style={{ marginLeft: 12 }} />
...
const styles = StyleSheet.create({
  ...
  logo: { fontSize: 20, fontWeight: '400', color: '#B0B0B0', marginBottom: 24 },
  ...
  statLabel: { fontSize: 16, fontWeight: '500', color: '#666', marginTop: 2 },
  ...
  emptySubtext: { fontSize: 16, color: '#BBB', marginTop: 6, textAlign: 'center' },
  ...
  historyLeft: { flex: 1 },
  historyDate: { fontSize: 14, fontWeight: '700', color: '#8EAAC8', marginBottom: 4 },
  ...
  historyDuration: { fontSize: 14, color: '#999' },
});
