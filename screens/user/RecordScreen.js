...
const styles = StyleSheet.create({
    ...
    promptLabel: { fontSize: 20, fontWeight: '600', color: '#4A7A99', marginBottom: 14 },
    promptText: {
    ...
    pausedText: { fontSize: 22, fontWeight: '700', color: '#595959', marginBottom: 6 },
    ...
    controlLabel: { fontSize: 14, fontWeight: '600', color: '#1A1A2E', marginTop: 2 },
    doneButton: {
    ...
    reviewDuration: { fontSize: 18, color: '#505050', marginBottom: 24 },
    playbackRow: {
